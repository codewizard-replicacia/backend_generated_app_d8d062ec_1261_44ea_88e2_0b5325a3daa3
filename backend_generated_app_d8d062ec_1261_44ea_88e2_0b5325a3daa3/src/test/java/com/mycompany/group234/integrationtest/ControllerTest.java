...
class ControllerTest {
  ...
  @Test
  void  testCreateVeteriansInstance() throws IOException {
    given()
        .contentType("application/json")
        .body(getPayload("VeteriansInstance.json"))
        .when()
   ...
   @Test
  public void testSystemFilterOptionsVeterians() throws IOException {
  ...
  void  teardown() {
    ...
    jdbcTemplate.execute("DELETE FROM generated_app.Veterians");
    jdbcTemplate.execute("DELETE FROM generated_app.Pet");
     ...
     jdbcTemplate.execute("DELETE FROM generated_app.VeteriansExaminehealth");
